...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Username_loginusername'), 'tester546')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_STORE/input_Password_loginpassword'), 'YFZfyx+NhJE=')
...
WebUI.setText(findTestObject('Page_STORE/input_Name_name'), 'Tester')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Country_country'), 'Indonesia')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_City_city'), 'Surabaya')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Credit card_card'), '11111111111111')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Month_month'), 'October')
